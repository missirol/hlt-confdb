...
public class JavaCodeExecution {
	...
	private void runChecker() {
        ...
        private void customiseForCMSHLT2593(){
          ArrayList<String> pathRegexs = new ArrayList<String>();
          pathRegexs.add("HLT_AK4CaloJet100_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet100_Jet35_Eta0p7ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet100_Jet35_Eta1p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet100_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet110_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet120_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet120_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet150ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet30_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet40_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet40_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet50_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet60_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet80_45_45_Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet80_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet80_Jet35_Eta0p7ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet80_Jet35_Eta1p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4CaloJet80_v[0-9]+");
          pathRegexs.add("HLT_AK4PFBJetBCSV60_Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFBJetBCSV80_Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFBJetBSSV60_Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFBJetBSSV80_Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFDJet60_Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFDJet80_Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet100_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet100_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet110_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet120_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet120_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet30_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet40_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet50_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet60_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet80_Eta5p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_AK4PFJet80_v[0-9]+");
          pathRegexs.add("HLT_AK8PFJet15_v[0-9]+");
          pathRegexs.add("HLT_AK8PFJet25_v[0-9]+");
          pathRegexs.add("HLT_AK8PFJet330_TrimMass30_PFAK8BTagDeepCSV_p17_v[0-9]+");
          pathRegexs.add("HLT_AK8PFJet330_TrimMass30_PFAK8BTagDeepCSV_p1_v[0-9]+");
          pathRegexs.add("HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_np2_v[0-9]+");
          pathRegexs.add("HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_np4_v[0-9]+");
          pathRegexs.add("HLT_AK8PFJet330_TrimMass30_PFAK8BoostedDoubleB_p02_v[0-9]+");
          pathRegexs.add("HLT_CaloJet10_NoJetID_v[0-9]+");
          pathRegexs.add("HLT_CaloJet20_NoJetID_v[0-9]+");
          pathRegexs.add("HLT_CaloJet50_NoJetID_v[0-9]+");
          pathRegexs.add("HLT_CaloMET100_NotCleaned_v[0-9]+");
          pathRegexs.add("HLT_CaloMET110_NotCleaned_v[0-9]+");
          pathRegexs.add("HLT_CaloMET250_NotCleaned_v[0-9]+");
          pathRegexs.add("HLT_CaloMET300_NotCleaned_v[0-9]+");
          pathRegexs.add("HLT_CaloMET80_NotCleaned_v[0-9]+");
          pathRegexs.add("HLT_DQMPixels_SingleMuOpen_v[0-9]+");
          pathRegexs.add("HLT_DiPFJet15_FBEta3_NoCaloMatched_v[0-9]+");
          pathRegexs.add("HLT_DiPFJet15_NoCaloMatched_v[0-9]+");
          pathRegexs.add("HLT_DiPFJet25_FBEta3_NoCaloMatched_v[0-9]+");
          pathRegexs.add("HLT_DiPFJet25_NoCaloMatched_v[0-9]+");
          pathRegexs.add("HLT_DiPFJetAve15_HFJEC_v[0-9]+");
          pathRegexs.add("HLT_DiPFJetAve25_HFJEC_v[0-9]+");
          pathRegexs.add("HLT_DiPFJetAve35_HFJEC_v[0-9]+");
          pathRegexs.add("HLT_DiPhoton10sminlt0p14_v[0-9]+");
          pathRegexs.add("HLT_DiPhoton10sminlt0p16_v[0-9]+");
          //pathRegexs.add("HLT_Diphoton24_14_eta1p5_R9IdL_AND_HET_AND_IsoTCaloIdT_v[0-9]+");
          //pathRegexs.add("HLT_Diphoton24_16_eta1p5_R9IdL_AND_HET_AND_IsoTCaloIdT_v[0-9]+");
          pathRegexs.add("HLT_Diphoton30PV_18PV_R9Id_AND_IsoCaloId_AND_HE_R9Id_Mass55_v[0-9]+");
          pathRegexs.add("HLT_DmesonPPTrackingGlobal_Dpt15ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_DmesonPPTrackingGlobal_Dpt20ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_DmesonPPTrackingGlobal_Dpt30ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_DmesonPPTrackingGlobal_Dpt40ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_DmesonPPTrackingGlobal_Dpt50ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_DmesonPPTrackingGlobal_Dpt60ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_DmesonPPTrackingGlobal_Dpt8ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_DoubleMu20_7_Mass0to30_L1_DM4EG_v[0-9]+");
          pathRegexs.add("HLT_DoubleMu20_7_Mass0to30_L1_DM4_v[0-9]+");
          pathRegexs.add("HLT_DoubleMu20_7_Mass0to30_Photon23_v[0-9]+");
          pathRegexs.add("HLT_DoubleMu2_Jpsi_DoubleTkMu0_Phi_v[0-9]+");
          pathRegexs.add("HLT_DoubleMu40NoFiltersNoVtxDisplaced_v[0-9]+");
          pathRegexs.add("HLT_DoubleTrkMu_16_6_NoFiltersNoVtx_v[0-9]+");
          pathRegexs.add("HLT_Ele145_CaloIdVT_GsfTrkIdT_v[0-9]+");
          pathRegexs.add("HLT_Ele15_CaloIdL_TrackIdL_IsoVL_PFJet30_v[0-9]+");
          pathRegexs.add("HLT_Ele15_Ele8_CaloIdL_TrackIdL_IsoVL_v[0-9]+");
          pathRegexs.add("HLT_Ele17_WPLoose_Gsf_v[0-9]+");
          pathRegexs.add("HLT_Ele200_CaloIdVT_GsfTrkIdT_v[0-9]+");
          pathRegexs.add("HLT_Ele20_WPTight_Gsf_v[0-9]+");
          pathRegexs.add("HLT_Ele20_eta2p1_WPLoose_Gsf_v[0-9]+");
          pathRegexs.add("HLT_Ele250_CaloIdVT_GsfTrkIdT_v[0-9]+");
          pathRegexs.add("HLT_Ele27_Ele37_CaloIdL_MW_v[0-9]+");
          pathRegexs.add("HLT_Ele300_CaloIdVT_GsfTrkIdT_v[0-9]+");
          pathRegexs.add("HLT_FullTrack18ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_FullTrack24ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_FullTrack34ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_FullTrack45ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_FullTrack53ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL1CastorMediumJetForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL1DoubleMu0ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL1DoubleMu10ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2DoubleMu0_NHitQForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu15ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu20ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu3Eta2p5_AK4CaloJet100Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu3Eta2p5_AK4CaloJet40Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu3Eta2p5_AK4CaloJet60Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu3Eta2p5_AK4CaloJet80Eta2p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu3_NHitQ10ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu5_NHitQ10ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL2Mu7_NHitQ10ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL3DoubleMu0_OS_m2p5to4p5ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL3DoubleMu0_OS_m7to14ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL3Mu15ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL3Mu20ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL3Mu3_NHitQ15ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL3Mu5_NHitQ15ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HIL3Mu7_NHitQ15ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_HT450_Beamspot_v[0-9]+");
          pathRegexs.add("HLT_HT60_Beamspot_v[0-9]+");
          pathRegexs.add("HLT_IsoMu27_LooseChargedIsoPFTau20_Trk1_eta2p1_SingleL1_v[0-9]+");
          pathRegexs.add("HLT_IsoMu27_LooseChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_v[0-9]+");
          pathRegexs.add("HLT_IsoMu27_MET90_v[0-9]+");
          pathRegexs.add("HLT_IsoMu27_MediumChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_v[0-9]+");
          pathRegexs.add("HLT_IsoMu27_TightChargedIsoPFTauHPS20_Trk1_eta2p1_SingleL1_v[0-9]+");
          pathRegexs.add("HLT_IsoMu30_v[0-9]+");
          pathRegexs.add("HLT_L1BptxXOR_v[0-9]+");
          pathRegexs.add("HLT_L1DoubleJetANDTotem_v[0-9]+");
          pathRegexs.add("HLT_L1DoubleJetC50_v[0-9]+");
          pathRegexs.add("HLT_L1DoubleJet_gap_v[0-9]+");
          pathRegexs.add("HLT_L1DoubleJet_v[0-9]+");
          pathRegexs.add("HLT_L1DoubleMu0_v[0-9]+");
          pathRegexs.add("HLT_L1DoubleMu_v[0-9]+");
          pathRegexs.add("HLT_L1EXT_HCAL_LaserMon1_v[0-9]+");
          pathRegexs.add("HLT_L1EXT_HCAL_LaserMon4_v[0-9]+");
          pathRegexs.add("HLT_L1FatEvents_v[0-9]+");
          pathRegexs.add("HLT_L1HFveto_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF0OR_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF1AND_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF1OR_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF2AND_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF2ORNoBptxGating_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF2OR_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part0_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part1_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part2_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part3_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part4_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part5_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part6_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part7_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part8_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_part9_v[0-9]+");
          pathRegexs.add("HLT_L1MinimumBiasHF_OR_v[0-9]+");
          pathRegexs.add("HLT_L1RomanPot_part0_v[0-9]+");
          pathRegexs.add("HLT_L1RomanPot_part1_v[0-9]+");
          pathRegexs.add("HLT_L1RomanPot_part2_v[0-9]+");
          pathRegexs.add("HLT_L1RomanPot_part3_v[0-9]+");
          pathRegexs.add("HLT_L1SingleEG10_v[0-9]+");
          pathRegexs.add("HLT_L1SingleEG15_v[0-9]+");
          pathRegexs.add("HLT_L1SingleEG18_v[0-9]+");
          pathRegexs.add("HLT_L1SingleJet10erHE_v[0-9]+");
          pathRegexs.add("HLT_L1SingleJet12erHE_v[0-9]+");
          pathRegexs.add("HLT_L1SingleJet16_v[0-9]+");
          pathRegexs.add("HLT_L1SingleJet200_v[0-9]+");
          pathRegexs.add("HLT_L1SingleJet20_v[0-9]+");
          pathRegexs.add("HLT_L1SingleJet35_v[0-9]+");
          pathRegexs.add("HLT_L1SingleJet8erHE_v[0-9]+");
          pathRegexs.add("HLT_L1SingleMu3_v[0-9]+");
          pathRegexs.add("HLT_L1SingleMu5_v[0-9]+");
          pathRegexs.add("HLT_L1SingleMu7_v[0-9]+");
          pathRegexs.add("HLT_L1SingleMuOpen_DT_v[0-9]+");
          pathRegexs.add("HLT_L1SingleMuOpen_v[0-9]+");
          pathRegexs.add("HLT_L1SingleMu_v[0-9]+");
          pathRegexs.add("HLT_L1TOTEM1_MinBias_v[0-9]+");
          pathRegexs.add("HLT_L1TOTEM2_ZeroBias_v[0-9]+");
          pathRegexs.add("HLT_L1TOTEM_3_v[0-9]+");
          pathRegexs.add("HLT_L1_DoubleJet30_Mass_Min400_Mu10_v[0-9]+");
          pathRegexs.add("HLT_L2DoubleMu23_NoVertex_v[0-9]+");
          pathRegexs.add("HLT_L2Mu10_v[0-9]+");
          pathRegexs.add("HLT_L2Mu50_v[0-9]+");
          pathRegexs.add("HLT_MediumChargedIsoPFTau200HighPtRelaxedIso_Trk50_eta2p1_v[0-9]+");
          pathRegexs.add("HLT_MediumChargedIsoPFTau220HighPtRelaxedIso_Trk50_eta2p1_v[0-9]+");
          pathRegexs.add("HLT_MonoCentralPFJet80_PFMETNoMu110_PFMHTNoMu110_IDTight_v[0-9]+");
          pathRegexs.add("HLT_MonoCentralPFJet80_PFMETNoMu120_PFMHTNoMu120_IDTight_v[0-9]+");
          pathRegexs.add("HLT_MonoCentralPFJet80_PFMETNoMu130_PFMHTNoMu130_IDTight_v[0-9]+");
          pathRegexs.add("HLT_MonoCentralPFJet80_PFMETNoMu140_PFMHTNoMu140_IDTight_v[0-9]+");
          pathRegexs.add("HLT_Mu12_DoublePhoton20_v[0-9]+");
          pathRegexs.add("HLT_Mu12_v[0-9]+");
          pathRegexs.add("HLT_Mu18_Mu9_DZ_v[0-9]+");
          pathRegexs.add("HLT_Mu18_Mu9_SameSign_DZ_v[0-9]+");
          pathRegexs.add("HLT_Mu18_Mu9_v[0-9]+");
          pathRegexs.add("HLT_Mu20_Mu10_DZ_v[0-9]+");
          pathRegexs.add("HLT_Mu20_Mu10_SameSign_DZ_v[0-9]+");
          pathRegexs.add("HLT_Mu20_Mu10_SameSign_v[0-9]+");
          pathRegexs.add("HLT_Mu20_Mu10_v[0-9]+");
          pathRegexs.add("HLT_Mu23_Mu12_DZ_v[0-9]+");
          pathRegexs.add("HLT_Mu23_Mu12_SameSign_DZ_v[0-9]+");
          pathRegexs.add("HLT_Mu23_Mu12_SameSign_v[0-9]+");
          pathRegexs.add("HLT_Mu23_Mu12_v[0-9]+");
          pathRegexs.add("HLT_Mu23_TrkIsoVVL_Ele8_CaloIdL_TrackIdL_IsoVL_DZ_v[0-9]+");
          pathRegexs.add("HLT_PFHT350MinPFJet15_v[0-9]+");
          pathRegexs.add("HLT_PFHT700_PFMET95_PFMHT95_IDTight_v[0-9]+");
          pathRegexs.add("HLT_PFHT800_PFMET85_PFMHT85_IDTight_v[0-9]+");
          pathRegexs.add("HLT_PFJet15_v[0-9]+");
          pathRegexs.add("HLT_PFJet25_v[0-9]+");
          pathRegexs.add("HLT_PFMET100_PFMHT100_IDTight_CaloBTagDeepCSV_3p1_v[0-9]+");
          pathRegexs.add("HLT_PFMET105_PFJet100_looseRecoiling_v[0-9]+");
          pathRegexs.add("HLT_PFMET110_PFJet100_looseRecoiling_v[0-9]+");
          pathRegexs.add("HLT_PFMET110_PFMHT110_IDTight_CaloBTagDeepCSV_3p1_v[0-9]+");
          pathRegexs.add("HLT_PFMET120_PFMHT120_IDTight_CaloBTagDeepCSV_3p1_v[0-9]+");
          pathRegexs.add("HLT_PFMET130_PFMHT130_IDTight_CaloBTagDeepCSV_3p1_v[0-9]+");
          pathRegexs.add("HLT_PFMET140_PFMHT140_IDTight_CaloBTagDeepCSV_3p1_v[0-9]+");
          pathRegexs.add("HLT_Photon100EB_TightID_TightIso_v[0-9]+");
          pathRegexs.add("HLT_Photon100EEHE10_v[0-9]+");
          pathRegexs.add("HLT_Photon100EE_TightID_TightIso_v[0-9]+");
          pathRegexs.add("HLT_Photon120EB_TightID_TightIso_v[0-9]+");
          pathRegexs.add("HLT_Photon22_v[0-9]+");
          pathRegexs.add("HLT_Photon25_v[0-9]+");
          pathRegexs.add("HLT_Photon40_HoverELoose_v[0-9]+");
          pathRegexs.add("HLT_Photon50_HoverELoose_v[0-9]+");
          pathRegexs.add("HLT_Photon50_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ300DEta3_PFMET50_v[0-9]+");
          pathRegexs.add("HLT_Photon60_HoverELoose_v[0-9]+");
          pathRegexs.add("HLT_Photon60_R9Id90_CaloIdL_IsoL_DisplacedIdL_v[0-9]+");
          pathRegexs.add("HLT_Photon60_R9Id90_CaloIdL_IsoL_v[0-9]+");
          pathRegexs.add("HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_CaloMJJ300_PFJetsMJJ400DEta3_v[0-9]+");
          pathRegexs.add("HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_CaloMJJ400_PFJetsMJJ600DEta3_v[0-9]+");
          pathRegexs.add("HLT_Photon75_R9Id90_HE10_IsoM_EBOnly_PFJetsMJJ600DEta3_v[0-9]+");
          pathRegexs.add("HLT_Photon90_CaloIdL_PFHT700_v[0-9]+");
          pathRegexs.add("HLT_PixelTracks_Multiplicity110ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_PixelTracks_Multiplicity135ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_PixelTracks_Multiplicity160ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_PixelTracks_Multiplicity60ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_PixelTracks_Multiplicity85ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_QuadPFJet98_83_71_15_DoublePFBTagDeepCSV_1p3_7p7_VBF1_v[0-9]+");
          pathRegexs.add("HLT_QuadPFJet98_83_71_15_DoublePFBTagDeepJet_1p3_7p7_VBF1_v[0-9]+");
          pathRegexs.add("HLT_QuadPFJet98_83_71_15_PFBTagDeepCSV_1p3_VBF2_v[0-9]+");
          pathRegexs.add("HLT_QuadPFJet98_83_71_15_PFBTagDeepJet_1p3_VBF2_v[0-9]+");
          pathRegexs.add("HLT_QuadPFJet98_83_71_15_v[0-9]+");
          pathRegexs.add("HLT_Random_TOTEM_part0_v[0-9]+");
          pathRegexs.add("HLT_Random_TOTEM_part1_v[0-9]+");
          pathRegexs.add("HLT_Random_TOTEM_part2_v[0-9]+");
          pathRegexs.add("HLT_Random_TOTEM_part3_v[0-9]+");
          pathRegexs.add("HLT_Rsq0p35_v[0-9]+");
          pathRegexs.add("HLT_Rsq0p40_v[0-9]+");
          pathRegexs.add("HLT_RsqMR300_Rsq0p09_MR200_4jet_v[0-9]+");
          pathRegexs.add("HLT_RsqMR300_Rsq0p09_MR200_v[0-9]+");
          pathRegexs.add("HLT_RsqMR320_Rsq0p09_MR200_4jet_v[0-9]+");
          pathRegexs.add("HLT_RsqMR320_Rsq0p09_MR200_v[0-9]+");
          pathRegexs.add("HLT_SinglePhoton10_Eta3p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_SinglePhoton15_Eta3p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_SinglePhoton20_Eta3p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_SinglePhoton30_Eta3p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_SinglePhoton40_Eta3p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_SinglePhoton50_Eta3p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_SinglePhoton60_Eta3p1ForPPRef_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu5NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu6NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelClusterCounting_BPixNClu7NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult1_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult1_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult1_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult1_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult2_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult2_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult2_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult2_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_BPixOnly_Mult3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult1_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult1_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult1_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult1_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult2_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult2_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult2_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult2_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_1_AND_PixelTrackCounting_Mult3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu5NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu6NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelClusterCounting_BPixNClu7NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult1_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult1_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult1_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult1_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult2_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult2_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult2_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult2_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_BPixOnly_Mult3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult1_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult1_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult1_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult1_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult2_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult2_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult2_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult2_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_2_AND_PixelTrackCounting_Mult3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu5NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu6NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay4_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay4_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay4_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelClusterCounting_BPixNClu7NLay4_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult1_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult1_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult1_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult1_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult2_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult2_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult2_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult2_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_BPixOnly_Mult3_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult1_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult1_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult1_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult1_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult2_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult2_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult2_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult2_part3_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult3_part0_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult3_part1_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult3_part2_v[0-9]+");
          pathRegexs.add("HLT_TOTEM_4_AND_PixelTrackCounting_Mult3_part3_v[0-9]+");
          pathRegexs.add("HLT_Trimuon2_Upsilon5_Muon_NoL1Mass_v[0-9]+");
          pathRegexs.add("HLT_TrkMu16NoFiltersNoVtx_v[0-9]+");
          pathRegexs.add("HLT_TrkMu16_DoubleTrkMu6NoFiltersNoVtx_v[0-9]+");
          pathRegexs.add("HLT_TrkMu17_DoubleTrkMu8NoFiltersNoVtx_v[0-9]+");
          pathRegexs.add("HLT_TrkMu6NoFiltersNoVtx_v[0-9]+");
          pathRegexs.add("HLT_VBF_DoubleLooseChargedIsoPFTauHPS20_Trk1_eta2p1_v[0-9]+");
          pathRegexs.add("HLT_VBF_DoubleMediumChargedIsoPFTauHPS20_Trk1_eta2p1_v[0-9]+");
          pathRegexs.add("HLT_ZeroBias_TOTEM_part0_v[0-9]+");
          pathRegexs.add("HLT_ZeroBias_TOTEM_part1_v[0-9]+");
          pathRegexs.add("HLT_ZeroBias_TOTEM_part2_v[0-9]+");
          pathRegexs.add("HLT_ZeroBias_TOTEM_part3_v[0-9]+");
